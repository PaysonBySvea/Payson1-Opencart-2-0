                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="paysondirect_mode" id="input-method-mode" class="form-control">
                                <option value="1" <?php echo ($paysondirect_mode?'selected':''); ?> ><?php echo $paysondirect_method_mode_live; ?></option>
                                <option value="0" <?php echo ($paysondirect_mode?'':'selected'); ?> ><?php echo $paysondirect_method_mode_sandbox; ?></option>
                            </select>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="paysondirect_payment_method" id="input-payment-method" class="form-control">
                                <option value="0" <?php echo ($paysondirect_payment_method == 0 ? 'selected="selected"' : '""') . '>' . $payment_method_none; ?></option>
