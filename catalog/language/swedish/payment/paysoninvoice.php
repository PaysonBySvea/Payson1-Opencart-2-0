...
$_['text_title']   = '<img src="https://cdn.svea.com/webpay/payson/payson_faktura.png" style="width:140px;height:55px;clear:right" alt="Payson Faktura" title="Paysoninvoice" />  - (Fakturaavgift inkl moms: %s SEK)';
